...
![wp-login.php with scouting-login](https://ps.w.org/wpsol/assets/screenshot-1.png?rev=20221226)

### 2. sidebar-widget in theme twenty-fifteen

![sidebar-widget in theme twenty-fifteen](https://ps.w.org/wpsol/assets/screenshot-2.png?rev=20221226)

### 3. sidebar-widget in theme twenty-fourteen

![sidebar-widget in theme twenty-fourteen](https://ps.w.org/wpsol/assets/screenshot-3.png?rev=20221226)

### 4. sidebar-widget in theme twenty-thirteen

![sidebar-widget in theme twenty-thirteen](https://ps.w.org/wpsol/assets/screenshot-4.png?rev=20221226)

### 5. sidebar-widget in theme twenty-twelve

![sidebar-widget in theme twenty-twelve](https://ps.w.org/wpsol/assets/screenshot-5.png?rev=20221226)

### 6. sidebar-widget in custom theme

![sidebar-widget in custom theme](https://ps.w.org/wpsol/assets/screenshot-6.png?rev=20221226)
